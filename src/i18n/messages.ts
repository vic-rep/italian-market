...
export const messages = {
  en: {
    ...
    lifestyle: {
      ...
      bulletDescs: [
        'Sort your policy from your phone. The nearest branch is wherever you are.',
        'Documents are digital. We generate them; you just confirm.',
        'No number, no waiting room. Most requests resolve in under two minutes.',
        'Plate and phone number — that is the entire input. Done in ten seconds.',
        'Your data is encrypted and never sold. Delete it any time.',
      ],
  ...
  it: {
    ...
    lifestyle: {
      ...
      bulletDescs: [
        'Gestisci la polizza dal telefono. Lo sportello più vicino è dove sei tu.',
        'I documenti sono digitali. Li generiamo noi; tu confermi e basta.',
        'Nessun numero da ritirare. La maggior parte si risolve in meno di due minuti.',
        'Targa e numero di cellulare — questo è tutto. Dieci secondi al massimo.',
        'I tuoi dati sono crittografati e non vengono mai ceduti. Cancellali quando vuoi.',
      ],
  ...
  bg: {
    ...
    lifestyle: {
      ...
      bulletDescs: [
        'Управлявай полицата си от телефона. Не е нужно да идваш никъде.',
        'Документите са дигитални. Ние ги оформяме; ти само потвърждаваш.',
        'Без номерче за изчакване. Повечето случаи се решават под две минути.',
        'Регистрационен номер и телефон — само толкова. До десет секунди.',
        'Данните ти са криптирани и никога не се продават. Изтрий ги кога пожелаеш.',
      ],
